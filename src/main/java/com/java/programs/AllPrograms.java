...
public class AllPrograms {
	...
	/*
	 * If we have return statement in try, then return statement should be
	 * called at the end of the method as well, Or else compile time error
	 * should be displayed. If we have return statement in try and catch, then
	 * no need to specify another one return statement at the end of the method.
	 * If we have return statement before any line inside method, then
	 * unreachable code warning should be shown.
	 */
	...
	/**
	 * Main method should be static because it will be accessed without object
	 * reference. Main method should be declared public, because it should be
	 * visible to every members in the package. Main method can't return any
	 * types, thus it should be void always Main method should be given with
	 * param of array type to driver data from command line.
	 */
